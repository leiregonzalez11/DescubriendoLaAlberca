package com.example.tfg.EspacioDelViajero.Maps.otrosLugares.parquebatuecas;
...
import com.example.tfg.EspacioDelViajero.Maps.otrosLugares.batuecas;
...
public class monasterioBatuecas extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String[] datos = dbHelper.obtenerInfoLugares(idioma, "monasteriointro","batuecas", 2);
